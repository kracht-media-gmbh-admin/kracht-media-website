            ...
            <div className="flex flex-col gap-2 group">
                ...
                <div className="relative">
                    <textarea
                        ref={ref}
                        className={cn(
                            "w-full bg-gradient-to-br from-white/[0.03] to-white/[0.01] backdrop-blur-sm border-2 border-white/10 rounded-xl px-4 py-4 text-lg text-white font-medium placeholder-white/20 outline-none transition-all duration-500 resize-y min-h-[150px]",
