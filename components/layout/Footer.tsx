...
import { COMPANY_INFO, LEGAL_ROUTES, SOCIAL_LINKS } from "@/lib/site";
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
          ...
          <div className="mt-8 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-0 border-t border-white/10">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <nav aria-label="Soziale Netzwerke" className="flex items-center gap-3">
                {SOCIAL_LINKS.map(({ name, href, label }) => (
                  <a
                    ...
                    className="text-white/80 hover:text-orange-web transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-web focus-visible:ring-offset-2 focus-visible:ring-offset-kracht-gruen rounded p-1"
                    aria-label={label}
                  >
                    {name === "Facebook" ? (
